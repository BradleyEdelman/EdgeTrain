...
def log_usage_plot(log_file):
    ...
    ax1[2].plot(df['Epoch #'], df['Mem Score'], label='Mem Score', color='tab:blue', linewidth=1.5)
    ax1[2].plot(df['Epoch #'], df['Acc Score'], label='Acc Score', color='tab:orange', linewidth=1.5)
    ...
    # Plot memory and accuracy scores
    ax1[3].plot(df['Epoch #'], df['Priority Batch Size'], label='Priority Batch Size', color='tab:green', linewidth=1.5)
    ax1[3].plot(df['Epoch #'], df['Priority Learning Rate'], label='Priority Learning Rate', color='tab:purple', linewidth=1.5)
    ...
    ax2 = ax1[4].twinx()
    ax1[4].plot(df['Epoch #'], df['Batch Size'], label='Batch Size', color='tab:green', linewidth=1.5)
    ax1[4].set_ylim(0, 50)
    ax2.plot(df['Epoch #'], df['Learning Rate']*100, label='Learning Rate', color='tab:purple', linewidth=1.5)
    ax2.plot(df['Epoch #'], df['Pruning'], label='Pruning', color='tab:red', linewidth=1.5)
