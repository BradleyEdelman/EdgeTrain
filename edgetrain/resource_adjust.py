...
def adjust_batch_size(batch_size, cpu_threshold=[20, 80], gpu_threshold=[20, 80], increment=8, resources=None):
    """
...
def adjust_learning_rate(lr, cpu_threshold=[20, 80], gpu_threshold=[20, 80], increment=0.01, resources=None):
    """
